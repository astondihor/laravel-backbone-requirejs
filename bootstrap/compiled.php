...
class Application extends Container implements HttpKernelInterface, TerminableInterface, ResponsePreparerInterface
{
    ...
    {
        return '/Users/astondihor/Sites/workflow/workflow/laravel-backbone-requirejs-bower-grunt/src/vendor/laravel/framework/src/Illuminate/Foundation' . '/start.php';
    }
